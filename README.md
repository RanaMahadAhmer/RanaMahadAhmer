...
- 🏢 Customizing **ERPNext / HRMS** modules (Frappe, Python, MariaDB) for accounting firms
...
```
Languages    Kotlin · Java · Dart · Python · JavaScript · C++ · Bash
Mobile       Jetpack Compose · Flutter · Compose Multiplatform · KMP
Backend      Node.js · Ktor · Spring Boot · Frappe Framework
Frontend     React
Cloud        Firebase · GCP · AWS · Vercel
Databases    PostgreSQL · MariaDB · MySQL · MongoDB · Firestore · Room · SQLite
...
| **ERPNext HRMS Solutions** | Python, Frappe, ERPNext, MariaDB | Custom HR modules deployed for 3+ firm clients |
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000?style=flat&logo=vercel&logoColor=white)](https://developerner-dev.com)
[![NER-DEV](https://img.shields.io/badge/NER--DEV-111?style=flat&logo=firefoxbrowser&logoColor=orange)](https://ner-dev.com)
[![Email](https://img.shields.io/badge/Email-D14836?style=flat&logo=microsoftoutlook&logoColor=white)](mailto:ranamahadahmer@outlook.com)

---

<sub>NUST '25 · Software Engineering · Daska, Pakistan</sub>
